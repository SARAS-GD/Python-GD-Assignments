...
class Homework:
    def __init__(self, text, days_to_complete):
        self.text = text
        self.deadline = datetime.timedelta(days=days_to_complete) #used to perform arithmetic opeartion on date
...
class Teacher:
    ...
    def create_homework(self,task, days_to_complete):
        """Create a Homework object with a task and a deadline."""
