...
if __name__ == '__main__':
    ...
    check_result(xml_path='/Users/srajuv/Desktop/Python-GD-Assignments/additional_topics/parsing_serialization_task/tests/example_result.xml', expected_country='Belarus', expected_cities=6)
