...
# Test case for the generate_random_data function
...
# Test case for file creation using schema and generating files
...
def test_generate_files(tmp_path, schema, lines):
    ...
    # Verify the file is created and contains correct data
    assert file_path.exists()
    with open(file_path) as f:
        lines = f.readlines()
